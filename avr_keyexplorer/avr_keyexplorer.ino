/*
 * This is and AVR firmware source code for "Unikeyboard explorer" (keyboard matrix scanning software).
 * Scans any keyboard of up to 26 pins and generates the debug output on UART for col/row of key pressed.
 * 
